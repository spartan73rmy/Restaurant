...
namespace MaterialSkin
{
    public static class MaterialSkinManager
    {
        ...
        {
            /*int style = NativeWinAPI.GetWindowLong(materialForm.Handle, NativeWinAPI.GWL_EXSTYLE);
            style |= NativeWinAPI.WS_EX_COMPOSITED;
            NativeWinAPI.SetWindowLong(materialForm.Handle, NativeWinAPI.GWL_EXSTYLE, style);*/
